  ...
  return (
    ...
    >
      ...
      <DecorativeFlower
        ...
        className="left-4 top-24 max-w-[60px] opacity-[0.07] md:left-8 md:top-28 md:max-w-[72px] md:opacity-[0.06]"
      />
      <DecorativeFlower
        src="/image/element-flower2.png"
        className="bottom-32 right-4 max-w-[58px] opacity-[0.07] md:right-8 md:bottom-40 md:max-w-[72px] md:opacity-[0.06]"
      />
      <img
        data-layer="deco"
        src="/image/element-base.png"
        alt=""
        className="absolute left-0 top-24 w-32 opacity-[0.22] md:top-28 md:w-40"
        aria-hidden
      />

      <div className="relative z-10 mx-auto max-w-4xl">
        <motion.p
          className="mb-4 text-center font-body text-[10px] font-medium uppercase tracking-[0.25em] text-stone-400 sm:mb-5 sm:text-xs md:tracking-[0.3em]"
          {...fadeUp}
        >
        ...
        <motion.p
          className="mx-auto mt-6 max-w-2xl text-center font-body text-lg leading-relaxed text-stone-700 sm:mt-8 sm:text-xl md:text-[1.25rem]"
          {...fadeUp}
        ...
        <div className="mt-14 grid grid-cols-1 gap-12 sm:mt-16 sm:gap-14 md:grid-cols-2 md:gap-20">
          {people.map((person, i) => (
            ...
            >
              <div className="relative aspect-square w-full max-w-[220px] overflow-hidden rounded-full shadow-xl transition-shadow duration-300 sm:max-w-[240px] md:max-w-[260px] md:shadow-2xl">
                <motion.img
                  src={person.img}
                  alt={person.name}
              ...
              <p className="mt-2 max-w-[240px] text-center font-body text-sm text-stone-500 sm:max-w-[260px] sm:text-[15px]">
                {person.line}
              </p>
            </motion.div>
          ))}
        ...
        <motion.div
          className="relative mx-auto mt-16 max-w-2xl space-y-5 text-center font-body text-[15px] leading-loose text-stone-600 sm:mt-20 sm:space-y-6 sm:text-base md:mt-24"
